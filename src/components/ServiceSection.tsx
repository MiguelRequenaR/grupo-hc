              ...
              <div className="absolute bottom-[-70px] left-1/2 -translate-x-1/2 w-10/12 bg-white p-7 border-l-4 border-[#f68b21] shadow-lg overflow-hidden cursor-pointer">
                ...
                <div className="relative z-20">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-bold text-[#f68b21] group-hover:text-white transition-colors duration-500">{service.subslug}</span>
                  </div>
                  <h3 className="pb-2 text-[17px] text-[#003d4d] group-hover:text-white transition-colors duration-500">{service.title}</h3>
                </div>
              </div>
