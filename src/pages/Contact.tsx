    ...
    <>
      ...
      <section className="py-20">
        ...
        <div className="max-w-7xl mx-auto md:p-20 grid grid-cols-1 md:grid-cols-2 gap-10 bg-white shadow-xl rounded-lg">
          <div className="bg-[#003d4d] p-10 rounded-lg space-y-3" data-aos="fade-up">
            ...
            <div className="space-y-10 my-auto">
              <div className="bg-white p-4 flex items-center gap-5 group cursor-pointer">
                ...
                <div className="flex flex-col space-y-1">
                  <span className="text-xl font-bold text-[#003d4d]">Dirección:</span>
              ...
              <div className="bg-white p-4 flex items-center gap-5 group cursor-pointer">
                ...
                <div className="flex flex-col space-y-1">
                  <span className="text-xl font-bold text-[#003d4d]">Número de contacto:</span>
              ...
              <div className="bg-white p-4 flex items-center gap-5 group cursor-pointer">
                ...
                <div className="flex flex-col space-y-1">
                  <span className="text-xl font-bold text-[#003d4d]">Email:</span>
                  <span>info@grupo-hc.com</span>
                </div>
              </div>
            </div>
          </div>
          <div className="space-y-3 bg-gray-100 p-10 rounded-lg" data-aos="fade-up" data-aos-delay="100">
            ...
            <p className="text-sm md:text-lg">Llena el formulario para reservar una cita con nosotros.</p>
            <Form />
          </div>
        </div>
      </section>
